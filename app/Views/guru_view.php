...
<body>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3 row">
                                    <label for="inputBidang" class="col-sm-2 col-form-label">Mata Pelajaran</label>
                                    <div class="col-sm-10">
                                        <select id="inputBidang" name="bidang" class="form-select">
                                            <option value="agama">Agama</option>
                                            <option value="bindonesia">Bahasa Indonesia</option>
    ...
    <script>
        function hapus($id) {
            ...
            if (result) {
                window.location = "<?php echo site_url("guru/hapus") ?>/" + $id;
            }
        }
        ...
        function edit($id) {
            $.ajax({
                ...
                success: function(hasil) {
                    console.log("Edit AJAX Success:", hasil);
                    ...
                    if ($obj.id != '') {
                        ...
                        console.log("No data received for editing.");
                    }
                },
